...
<html>
<head>
	<title>SENG 401 - Task 4</title>
</head>
<body>
<p><b>Enter your coordinates:</b></p>

<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	<b>Point 1:</b><br>
	Latitude: <input type="number" name="lat1" step="0.0001">
	Longitude: <input type="number" name="lon1" step="0.0001">
	<br><br>
	<b>Point 2:</b><br>
	Latitude: <input type="number" name="lat2" step="0.0001">
	Longitude: <input type="number" name="lon2" step="0.0001">
	<br><br>
